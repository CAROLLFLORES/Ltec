...
SECRET_KEY = 'django-insecure-tmm9)s7ucu(5@t4onwrypj_jf_&@_%2dwd$hstb10_memp+wa1'

# SECURITY WARNING: don't run with debug turned on in production!
#de true a false para PUBLICAR
DEBUG = True
...
WSGI_APPLICATION = 'ltec.wsgi.application'
...
# Asegúrate de tener esto si estás en desarrollo
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Asegúrate de que esta ruta apunta a tu carpeta 'static'
]
